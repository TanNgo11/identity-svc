...
import com.shadcn.identity.repository.InvalidatedTokenRepository;
import com.shadcn.identity.repository.RefreshTokenRepository;
import com.shadcn.identity.repository.RoleRepository;
import com.shadcn.identity.repository.UserRepository;
import com.shadcn.identity.repository.httpclient.OutboundIdentityClient;
import com.shadcn.identity.repository.httpclient.OutboundUserClient;
...
public class AuthenticationService implements IAuthenticationService {
    ...
    public AuthenticationResponse OutboundAuthenticate(String code) {
        ...
        Role userRole =
                roleRepository.findByName(com.shadcn.identity.enums.Role.STUDENT.name()).orElseThrow(() -> new
